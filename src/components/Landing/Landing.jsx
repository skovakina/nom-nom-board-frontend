    ...
    <>
      <main className="min-h-screen bg-gradient-to-b from-orange-200 via-yellow-100 to-white flex flex-col items-center">
        ...
        <div className="w-full md:w-[696px] h-auto md:h-[459px] mt-[50px] md:mt-[100px] flex flex-col items-center justify-center py-8">
          ...
          <div className="flex items-center justify-center py-2 px-4 gap-[10px] rounded-md bg-gray-50 text-gray-600 text-sm font-poppins font-medium mb-4">
          ...
          <p className="text-[16px] md:text-[20px] font-poppins font-medium leading-none text-gray-600 text-center w-full md:w-[696px] h-auto md:h-[90px] mb-4">
            ...
            that makes planning, prepping, and reflecting on your meals fun and
            visual.
          </p>

          <Button className="py-2 px-4 gap-[8px] rounded-[6px] border border-black bg-black text-white font-poppins font-medium mb-4">
